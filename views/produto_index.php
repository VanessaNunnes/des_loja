                ...
                <tbody>
                    <?php foreach ($produtos as $produto) { ?>
                        <tr>
                            ...
                            <td> <a style="width: 90px" class="btn btn-primary" href="produto.php?action=show&id=<?= $produto['id'] ?>"><i class="fa-solid fa-eye"></i> Show </a> </td>
                            <td> <a style="width: 80px" class="btn btn-info" href="produto.php?action=edit&id=<?= $produto['id'] ?>"> <i class="fa-solid fa-pen-to-square"></i> Edit </a> </td>
                            <td> <button style="width: 90px" class="btn btn-danger" onclick="onDelete(<?= $produto['id'] ?>)"><i class="fa-solid fa-trash"></i> Delete </button> </td>
                        </tr>
